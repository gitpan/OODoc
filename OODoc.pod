...
$obj-E<gt>B<createManual>(NAME|CLASS|OBJECT, OPTIONS)
...
and C<html> representing L<OODoc::Format::Pod|OODoc::Format::Pod> and OODoc::Format::Html subroutine 
...
Options passed to the formatter when created.  See the applicable formatter
manual page.
