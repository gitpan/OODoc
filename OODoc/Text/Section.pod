...
OODoc::Text::Section-E<gt>B<new>(OPTIONS)

=over 4

 Option       Defined in       Default                  
 chapter                       <required>               
 container    L<OODoc::Text>   L<new(chapter)|"METHODS">
 description  L<OODoc::Text>   C<''>                    
 level        L<OODoc::Text::Structure>  C<2>                     
 linenr       L<OODoc::Text>   <required>               
 name         L<OODoc::Text>   undef                    
 type         L<OODoc::Text>   C<'Section'>             
...
$obj-E<gt>B<subsection>(NAME|OBJECT)
...
$obj-E<gt>B<subsections>([SUBSECTIONS])
