...
See L<formatManual(append)|"Page generation"> for an explanation.
...
called with all the options that L<showChapter()|"Page generation"> usually gets.
...
hand.  This should be passed with L<new(project)|"METHODS">.
...
directory must be provided via L<new(workdir)|"METHODS">, but was not specified.
...
L<createManual(format_options)|OODoc::Format/"Page generation"> or L<OODoc::create(format_options)|"Formatter">
can be used with a list of formatting options which are passed to
L<showChapter()|"Page generation">.  This will help you to produce pages which have
...
a very simple approach simply using L<createManual(append)|"Page generation">.
...
the default behavior of L<chapterInheritance()|"Page generation"> by producing nothing.
...
When using 'pod2' in stead of 'pod' when L<OODoc::create()|"Formatter"> is called,
...
See the manual page of Text::MagicTemplate.  You have to install
Bundle::Text::MagicTemplate to get it to work.
