...
Create manual pages in the HTML syntax, using the Text::MagicTemplate subroutine 
...
The general L<cleanup()|OODoc::Format/"Attributes"> is too over eager: it turns all pieces of text
...
$obj-E<gt>B<templateIndex>(ATTRS, OPTIONS)
...
$obj-E<gt>B<templateInheritance>(OPTIONS)

=over 4

=back

$obj-E<gt>B<templateList>(ATTRS, OPTIONS)
...
underscore is used because Text::MagicTemplate subroutine  does not accept commas
...
$obj-E<gt>B<templateMeta>(ATTR, ARGS)
...
These options overrule the general L<createManual(format_options)|OODoc::Format/"Attributes"> values
