...
Create manual pages in the HTML syntax, using the Text::MagicTemplate
...
=over 4
 ...
 manifest        L<OODoc::Format>  C<undef>            
 project         L<OODoc::Format>  <required>          
 version         L<OODoc::Format>  <required>          
 workdir         L<OODoc::Format>  <required>          
...
The general L<cleanup()|"Page generation"> is too over eager: it turns all pieces of text
...
=over 4
 ...
 Option   Defined in       Default            
 process  L<OODoc::Format>  qr/\.(s?html|cgi)$/
 source   L<OODoc::Format>  "html/other/"      
 verbose  L<OODoc::Format>  0                  
...
$obj-E<gt>B<templateDate>(ATTRS, ARGS)

=over 4

=back

$obj-E<gt>B<templateHref>(ATTRS, ARGS)

=over 4

=back

$obj-E<gt>B<templateIndex>(ATTRS, ARGS)
...
$obj-E<gt>B<templateInheritance>(ATTRS, ARGS)

=over 4

=back

$obj-E<gt>B<templateList>(ATTRS, ARGS)
...
underscore is used because Text::MagicTemplate does not accept commas
...
$obj-E<gt>B<templateManual>(ATTRS, ARGS)

=over 4

=back

$obj-E<gt>B<templateMeta>(ATTRS, ARGS)
...
$obj-E<gt>B<templateName>(ATTRS, ARGS)

=over 4

=back

$obj-E<gt>B<templateTitle>(ATTRS, ARGS)

=over 4

=back

$obj-E<gt>B<templateVersion>(ATTRS, ARGS)
...
A call to L<addManual()|"Manual Repository"> expects a new manual object (a L<OODoc::Manual|OODoc::Manual>),
however an incompatible thing was passed.  Usually, intended was a call
to L<manualsForPackage()|"Manual Repository"> or L<mainManual()|"Manual Repository">.
