...
it is created implicitly when L<OODoc::create()|"Formatter"> is called on a L<OODoc|OODoc>
object.
...
The short name of this project (module), set by L<OODoc::new(module)|"METHODS">.
...
=over 4
 ...
 manual                                   <required>           
 output                                   <selected filehandle>
 show_described_options                   C<'EXPAND'>          
 show_described_subs                      C<'EXPAND'>          
 show_inherited_options                   C<'USE'>             
 show_inherited_subs                      C<'USE'>             
 show_option_table                        C<'ALL'>             
 show_subs_index                          C<'NO'>              
 subroutines                              C<[]>                
