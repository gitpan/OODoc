...
I<Error:> Cannot read version from file $fn: $!
...
I<Error:> no version specified for distribution "$name"
...
I<Error:> the destribution must be specified


I<Error:> there is no version defined for the source files
...
I<Error:> use regex, code reference or array for file selection
