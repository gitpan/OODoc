...
S<< container    L<OODoc::Text>   L<new(section)|OODoc::Text::SubSection/"METHODS"> >>
S<< description  L<OODoc::Text>   '' >>
S<< level        L<OODoc::Text::Structure>  3 >>
S<< linenr       L<OODoc::Text>   <required> >>
S<< name         L<OODoc::Text>   undef >>
S<< section                       <required> >>
S<< type         L<OODoc::Text>   'Subsection' >>
