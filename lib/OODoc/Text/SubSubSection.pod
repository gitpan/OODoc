...
OODoc::Text::SubSubSection-E<gt>B<new>(OPTIONS)
...
OODoc::Text::SubSubSection-E<gt>B<filenameToPackage>(FILENAME)
...
OODoc::Text::SubSubSection-E<gt>B<mkdirhier>(DIRECTORY)
