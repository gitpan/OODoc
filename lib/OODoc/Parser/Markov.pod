...
$obj-E<gt>B<cleanupPodL>(FORMATTER, MANUAL, LINK)
...
$obj-E<gt>B<cleanupPodM>(FORMATTER, MANUAL, LINK)

=over 4

=back

$obj-E<gt>B<decomposeL>(MANUAL, LINK)
...
$obj-E<gt>B<decomposeM>(MANUAL, LINK)
...
$obj-E<gt>B<cleanupHtml>(FORMATTER, MANUAL, STRING, [IS_HTML])
...
$obj-E<gt>B<cleanupHtmlL>(FORMATTER, MANUAL, LINK)

=over 4

=back

$obj-E<gt>B<cleanupHtmlM>(FORMATTER, MANUAL, LINK)
...
I<Warning:> Manual $manual links to unknown entry "$item" in $manual
...
I<Warning:> empty L link in $manual
...
I<Warning:> module $name is not on your system, but linked to in $manual
...
I<Warning:> no manual for $package (correct casing?)
...
I<Warning:> option "$name" unknow for $name() in $package, found in $manual
...
I<Warning:> subroutine $name is not defined by $package, found in $manual
...
I<Warning:> use problem for module $link in $module; $@
