...
S<< manual                                       <required> >>
S<< output                                       <required> >>
S<< show_inherited_chapters                      'REFER' >>
S<< show_inherited_sections                      'REFER' >>
S<< show_inherited_subsections                   'REFER' >>
...
S<< manual                                   <required> >>
S<< options                                  <required> >>
S<< show_described_options                   'EXPAND' >>
S<< show_inherited_options                   'USE' >>
...
S<< Option               --Defined in--Default >>
S<< show_chapter_examples              'EXPAND' >>
...
S<< last                                     0 >>
S<< manual                                   <required> >>
S<< output                                   <selected filehandle> >>
S<< show_described_options                   'EXPAND' >>
S<< show_diagnostics                         'NO' >>
S<< show_examples                            'EXPAND' >>
S<< show_inherited_options                   'USE' >>
S<< show_option_table                        'ALL' >>
S<< show_sub_description                     'DESCRIBED' >>
S<< show_subroutine                          'EXPAND' >>
S<< subroutine                               <required> >>
...
S<< output                                   <selected filehandle> >>
S<< show_described_options                   'EXPAND' >>
S<< show_described_subs                      'EXPAND' >>
S<< show_inherited_options                   'USE' >>
S<< show_inherited_subs                      'USE' >>
S<< show_option_table                        'ALL' >>
S<< show_subs_index                          'NO' >>
S<< subroutines                              [] >>
